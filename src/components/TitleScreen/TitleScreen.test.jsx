  ...
  default: function MockInstructions({ mode }) {
    return (
      <div>
        ...
        {mode === "preGame" && (
          <div data-testid="pre-game-instructions">Pre Game Instructions</div>
        )}
      </div>
    );
  },
...
describe("TitleScreen", () => {
  it("renders all main images with correct alt texts", () => {
    ...
    expect(charactersImage).toHaveAttribute(
      "src",
      "/Assets/DOTC_characters.png"
    );
  });
